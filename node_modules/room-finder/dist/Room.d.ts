 ...
 */
export declare class Room<ForkName extends string> extends HallwayElement {
    /**
     ...
     */
    constructor(name?: (string | null) | undefined, side?: Direction, { edgeLengthFromPreviousNodeInHallway, prefix, aliases, nodeId, }?: {
        prefix?: string;
        aliases?: string[];
