 ...
 */
export declare class Fork<ForkName extends string> extends Room<ForkName> {
     ...
     */
    constructor(side: Direction, nodeId: ForkNode<ForkName> | ForkName, destinationName: string, edgeLengthFromPreviousNodeInHallway?: number | undefined);
    get fullName(): string;
}
